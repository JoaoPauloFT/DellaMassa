...
<head>
    ...
    <title>Lanches - Della Massa</title>
</head>
<body id="padrao">
    ...
    <main>
        <div>
            <form action="lanche.php" method="GET">
            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    $base = $pag * $base2;
                    if($pesquisar == "") {
                        $comando = "SELECT * FROM lanche ORDER BY id_lanche DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM lanche";
                    } else {
                        $comando = "SELECT * FROM lanche WHERE nome LIKE '%".$pesquisar."%' ORDER BY id_lanche DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM lanche WHERE nome LIKE '%".$pesquisar."%' LIMIT $base, $base2";
                    }
