...
<head>
    ...
    <title>Ingrediente - Della Massa</title>
</head>
<body id="padrao">
    ...
    <main style="text-align: left; padding: 15px 30px 30px 30px;">
        <div>
            <form action="formIngrediente.php" method="post">
    ...
    <script>
        function voltar() {
            window.location.href = 'ingrediente.php';
        }
