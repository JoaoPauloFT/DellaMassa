...
if (isset($_POST['id'])) {
    if($_POST['id'] != "") {
        include_once("../../classesDAO/acaiDAO.php");
        $fDAO = new acaiDAO();
        $fDAO->editar($_POST['id'], $_POST['nome'], $_POST['ingrediente'], $_POST['valor'], $_POST['status']);
        header('location:acai.php');
    } else {
        include_once("../../classesDAO/acaiDAO.php");
        $fDAO = new acaiDAO();
        $fDAO->inserir($_POST['nome'], $_POST['ingrediente'], $_POST['valor'], $_POST['status']);
        header('location:acai.php');
    }
}
...
<body id="padrao">
    ...
    <main style="text-align: left; padding: 15px 30px 30px 30px;">
        <div>
            <form action="formAcai.php" method="post">
