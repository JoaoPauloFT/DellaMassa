            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna3("",$contador,3,"Inserir", "formSobremesa","");
                        $tabela->insere_coluna3($campo["id_sobremesa"],$contador,4,"Editar", "formSobremesa","");
                        $tabela->insere_coluna3($campo["id_sobremesa"],$contador,5,"Excluir", "formSobremesa","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
