...
if (isset($_POST['id'])) {
    if($_POST['id'] != "") {
        include_once("../../classesDAO/esfihaDAO.php");
        $fDAO = new esfihaDAO();
        $fDAO->editar($_POST['id'], $_POST['nome'], $_POST['valor'], $_POST['tipo'], $_POST['status']);
        header('location:esfiha.php');
    } else {
        include_once("../../classesDAO/esfihaDAO.php");
        $fDAO = new esfihaDAO();
        $fDAO->inserir($_POST['nome'], $_POST['valor'], $_POST['tipo'], $_POST['status']);
        header('location:esfiha.php');
    }
}
...
<head>
    ...
    <title>Esfiha - Della Massa</title>
</head>
<body id="padrao">
    ...
    <main style="text-align: left; padding: 15px 30px 30px 30px;">
        <div>
            <form action="formEsfiha.php" method="post">
    ...
    <script>
        function voltar() {
            window.location.href = 'esfiha.php';
        }
