            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna3("",$contador,5,"Inserir", "formBebida","");
                        $tabela->insere_coluna3($campo["id_bebida"],$contador,6,"Editar", "formBebida","");
                        $tabela->insere_coluna3($campo["id_bebida"],$contador,7,"Excluir", "formBebida","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
