...
<head>
    ...
    <title>Bebidas - Della Massa</title>
</head>
<body id="padrao">
        ...
        <div>
            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    $base = $pag * $base2;
                    if($pesquisar == "") {
                        $comando = "SELECT * FROM bebida ORDER BY id_bebida DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM bebida";
                    } else {
                        $comando = "SELECT * FROM bebida WHERE nome LIKE '%".$pesquisar."%' ORDER BY id_bebida DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM bebida WHERE nome LIKE '%".$pesquisar."%' LIMIT $base, $base2";
                    }
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna($campo["id_bebida"],$contador,0);
                        $tabela->insere_coluna($campo["nome"],$contador,1);
                        $tabela->insere_coluna($campo["quantidade"],$contador,2);
                        $tabela->insere_coluna($campo["valor"],$contador,3);
                        $tabela->insere_coluna3("",$contador,4,"Inserir", "formBebida","");
                        $tabela->insere_coluna3($campo["id_bebida"],$contador,5,"Editar", "formBebida","");
                        $tabela->insere_coluna3($campo["id_bebida"],$contador,6,"Excluir", "formBebida","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
