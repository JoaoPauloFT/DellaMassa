            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna3("",$contador,4,"Inserir", "formPastel","");
                        $tabela->insere_coluna3($campo["id_pastel"],$contador,5,"Editar", "formPastel","");
                        $tabela->insere_coluna3($campo["id_pastel"],$contador,6,"Excluir", "formPastel","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
