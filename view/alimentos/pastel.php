...
<head>
    ...
    <title>Pasteis - Della Massa</title>
</head>
<body id="padrao">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a style="background-color: grey; color: white;" class="dropdown-item" href="pastel.php">Pastel</a></li>
    ...
    <main>
        <div>
            <form action="pastel.php" method="GET">
            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    $base = $pag * $base2;
                    if($pesquisar == "") {
                        $comando = "SELECT * FROM pastel ORDER BY id_pastel DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM pastel";
                    } else {
                        $comando = "SELECT * FROM pastel WHERE nome LIKE '%".$pesquisar."%' ORDER BY id_pastel DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM pastel WHERE nome LIKE '%".$pesquisar."%' LIMIT $base, $base2";
                    }
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna($campo["id_pastel"],$contador,0);
                        $tabela->insere_coluna($campo["nome"],$contador,1);
                        $tabela->insere_coluna($campo["valor"],$contador,2);
                        $tabela->insere_coluna3("",$contador,3,"Inserir", "formPastel","");
                        $tabela->insere_coluna3($campo["id_pastel"],$contador,4,"Editar", "formPastel","");
                        $tabela->insere_coluna3($campo["id_pastel"],$contador,5,"Excluir", "formPastel","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
