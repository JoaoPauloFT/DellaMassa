            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna3("",$contador,5,"Inserir", "formPorcao","");
                        $tabela->insere_coluna3($campo["id_porcao"],$contador,6,"Editar", "formPorcao","");
                        $tabela->insere_coluna3($campo["id_porcao"],$contador,7,"Excluir", "formPorcao","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
