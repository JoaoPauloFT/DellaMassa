...
<head>
    ...
    <title>Porções - Della Massa</title>
</head>
<body id="padrao">
    ...
    <main>
        <div>
            <form action="porcao.php" method="GET">
            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    $base = $pag * $base2;
                    if($pesquisar == "") {
                        $comando = "SELECT * FROM porcao ORDER BY id_porcao DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM porcao";
                    } else {
                        $comando = "SELECT * FROM porcao WHERE nome LIKE '%".$pesquisar."%' ORDER BY id_porcao DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM porcao WHERE nome LIKE '%".$pesquisar."%' LIMIT $base, $base2";
                    }
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna($campo["id_porcao"],$contador,0);
                        ...
                        $tabela->insere_coluna3("",$contador,4,"Inserir", "formPorcao","");
                        $tabela->insere_coluna3($campo["id_porcao"],$contador,5,"Editar", "formPorcao","");
                        $tabela->insere_coluna3($campo["id_porcao"],$contador,6,"Excluir", "formPorcao","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
