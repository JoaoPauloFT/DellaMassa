...
<head>
    ...
    <title>Bordas - Della Massa</title>
</head>
<body id="padrao">
    ...
    <main>
        <div>
            <form action="borda.php" method="GET">
            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    $base = $pag * $base2;
                    if($pesquisar == "") {
                        $comando = "SELECT * FROM borda ORDER BY id_borda DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM borda";
                    } else {
                        $comando = "SELECT * FROM borda WHERE nome LIKE '%".$pesquisar."%' ORDER BY id_borda DESC LIMIT $base, $base2";
                        $comandoCount = "SELECT COUNT(*) FROM borda WHERE nome LIKE '%".$pesquisar."%' LIMIT $base, $base2";
                    }
