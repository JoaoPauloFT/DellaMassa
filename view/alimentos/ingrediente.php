            ...
            <table class="table table-striped" id='conteudo'>
                ...
                <?php
                    ...
                    while ($campo=mysqli_fetch_array($result)){
                        ...
                        $tabela->insere_coluna3("",$contador,4,"Inserir", "formIngrediente","");
                        $tabela->insere_coluna3($campo["id_ingrediente"],$contador,5,"Editar", "formIngrediente","");
                        $tabela->insere_coluna3($campo["id_ingrediente"],$contador,6,"Excluir", "formIngrediente","");
                        $tabela->fecha_linha();
                        $contador++;
                    }
                ?>
