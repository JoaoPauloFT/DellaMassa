...
include_once("../../classes/sobremesa.php");
require "../../classes/tabela.php";
$tabela = new Tabela();
$c = new sobremesa();

if(isset($_POST['pedido'])) {
    include_once("../../classesDAO/sobremesaDAO.php");
    $cDAO = new sobremesaDAO();
...
<head>
    ...
    <title>Sobremesa - Della Massa</title>
</head>
<body id="padrao">
    ...
    <main style="text-align: left; padding: 15px 30px 30px 30px;">
        <div>
            <form action="formSobremesa.php" method="post">
    ...
    <script>
        function voltar() {
            window.location.href = 'sobremesa.php';
        }
